...
def infer(data_dir):
    ...
    sequences_dir = os.path.join(data_dir)
    ...
    for seq in sequences:
        ...
        for file in frames:
            ...
            path = os.path.join(args.logdir, seq, "ground_predictions", file)
            if not os.path.exists(os.path.join(args.logdir)):
                    os.makedirs(os.path.join(args.logdir))
            if not os.path.exists(os.path.join(args.logdir, seq)):
                    os.makedirs(os.path.join(args.logdir, seq))
            if not os.path.exists(os.path.join(args.logdir, seq, "ground_predictions")):
                    os.makedirs(os.path.join(args.logdir, seq, "ground_predictions"))
